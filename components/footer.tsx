...
// SVG social icons (lucide-react v1 doesn't include brand icons)
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-14">
        <div className="grid grid-cols-1 gap-10 sm:grid-cols-2 lg:grid-cols-5">
          ...
          <div className="lg:col-span-2 flex flex-col gap-4">
            <Link href="/" className="flex items-center gap-2 w-fit">
              ...
              <span className="text-xl font-bold bg-gradient-to-r from-orange-400 to-amber-400 bg-clip-text text-transparent tracking-tight">
                SkanoMenu
              </span>
            </Link>
            <p className="text-sm text-gray-400 leading-relaxed max-w-xs">
              The modern digital menu platform for restaurants. Beautiful menus, powerful
              analytics, and instant QR code generation — all in one place.
            </p>
            <div className="flex items-center gap-3 mt-1">
              {socialLinks.map(({ href, icon: Icon, label }) => (
                <a
                  ...
                  aria-label={label}
                  className="flex items-center justify-center w-9 h-9 rounded-lg bg-gray-800 text-gray-400 hover:bg-orange-500 hover:text-white transition-colors duration-200"
                >
        ...
        <div className="mt-12 border-t border-gray-800 pt-8 flex flex-col sm:flex-row items-center justify-between gap-4">
          <p className="text-sm text-gray-500">
            &copy; {new Date().getFullYear()} SkanoMenu Pro. All rights reserved.
          </p>
          <p className="text-xs text-gray-600">
            Built with love for great restaurants everywhere.
          </p>
        </div>
      </div>
    </footer>
